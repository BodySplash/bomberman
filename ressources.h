...
__declspec(selectany) const char* WINDOWCLASS = "Bomberman";
__declspec(selectany) const char* WINDOWTITLE = "Bomberman beta";
__declspec(selectany) HINSTANCE hInst = NULL;
...
// globales pour la map
 ...
 _declspec(selectany) int TILEWIDTH = 32;
 _declspec(selectany) int TILEHEIGHT = 32;
